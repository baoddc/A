                    ...
                    <div class="max-h-[400px] overflow-y-auto p-2 space-y-1 custom-scrollbar">
                        ${areas.filter(a => a.id !== 'tram-dien').map(area => {
                            ...
                            return `
                                <div 
                                    data-id="${area.id}"
                                    class="status-item p-2 rounded-lg border transition-all cursor-pointer flex flex-col gap-1 ${
                                        isHovered ? 'bg-red-50 border-red-200 shadow-sm' : 'bg-white border-gray-50 hover:bg-gray-50'
                                    }"
                                >
